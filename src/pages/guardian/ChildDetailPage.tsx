 ...
 if (grades.isError && attendance.isError) {
  return (
   <div className="flex flex-col items-center justify-center h-full">
    ...
    />
    <div className="pb-xl">
     <Link to="/guardian" className="bg-primary text-primary-foreground px-md py-sm rounded-full font-label-md">
      Back to Dashboard
     </Link>
    </div>
   </div>
    ...
    <div className="space-y-3">
     {grades.isLoading ? (
      ...
      grades.data.filter((g) => g.isConfirmed).map((g) => (
       <div key={g.id} className="rounded-lg bg-surface-container-lowest p-md ">
   ...
   {activeTab === "reports" && (
    <div className="space-y-3">
     {reports.isLoading ? (
      ...
      reports.data.map((r) => (
       <div key={r.id} className="rounded-lg bg-surface-container-lowest p-md ">
