  ...
  <>
   ...
   <div className="flex-1 p-md">
    {attempts.isLoading ? (
     ...
     <div className="max-w-4xl mx-auto bg-surface-container-lowest rounded-lg overflow-hidden">
           ...
           <TableCell className="px-4 py-3">
            <div className="flex items-center justify-end gap-2">
             {violations > 0 && (
              <Badge
               variant="outline"
               className="border-transparent bg-primary-container text-on-primary-container font-label-sm text-label-sm px-2 py-0.5 inline-flex items-center gap-1"
              >
             ...
             <Button
              asChild
              className="bg-primary text-primary-foreground px-4 h-auto py-1.5 rounded-lg font-label-md text-label-sm nudge-hover"
             >
