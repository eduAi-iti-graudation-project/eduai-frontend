    ...
    {readOnly ? (
     ...
     <div className="flex items-center gap-3">
      <Button
       ...
       className="bg-primary text-primary-foreground px-md h-auto py-sm rounded-lg font-label-md disabled:opacity-50 nudge-hover"
      >
   ...
   <div className="flex-1 p-md overflow-y-auto">
    ...
    {!showEditor ? (
     ...
     <div className="max-w-3xl mx-auto space-y-4">
      <div className="rounded-lg bg-surface-container-lowest p-md space-y-4 ">
       <div>
        ...
        <Input
         ...
         className="w-full h-auto rounded-full bg-surface px-3 py-2 text-label-md text-on-surface form-input-focus disabled:opacity-60"
        />
       </div>
       <div>
        ...
        <Textarea
         ...
         className="w-full min-h-0 rounded-full bg-surface px-3 py-2 text-label-md text-on-surface form-input-focus disabled:opacity-60 resize-none"
        />
       </div>
       <div>
        ...
        >
         <SelectTrigger className="w-full rounded-full bg-surface px-3 py-2 text-label-md text-on-surface form-input-focus disabled:opacity-60">
      ...
      <div className="flex items-center justify-between">
       ...
       {!readOnly && (
        <Button
         ...
         className="bg-primary text-primary-foreground px-md h-auto py-sm rounded-md font-label-md inline-flex items-center gap-1"
        >
      ...
      {questions.map((q, index) => (
       <div key={q.localId} className="rounded-lg bg-surface-container-lowest p-md ">
        <div className="flex items-center gap-2 mb-sm">
         ...
         <Select
          ...
          disabled={readOnly}
         >
          <SelectTrigger className="w-auto h-auto rounded-full bg-surface px-3 py-1.5 text-label-md text-on-surface form-input-focus disabled:opacity-60">
         ...
         <label className="flex items-center gap-1 text-label-md text-on-surface-variant">
          ...
          <Input
           ...
           disabled={readOnly}
           className="w-16 h-auto rounded-full bg-surface px-2 py-1.5 text-label-md text-on-surface form-input-focus disabled:opacity-60"
          />
         </label>
         {!readOnly && (
          <>
        ...
        <Textarea
         ...
         className="w-full min-h-0 rounded-full bg-surface px-3 py-2 text-label-md text-on-surface form-input-focus disabled:opacity-60 mb-sm resize-none"
        />
          ...
          {q.options.map((opt) => (
           <div key={opt.localId} className="flex items-center gap-2">
            ...
            <Input
             ...
             className="flex-1 h-auto rounded-full bg-surface px-3 py-2 text-label-md text-on-surface form-input-focus disabled:opacity-60"
            />
            {!readOnly && q.type === "MCQ" && (
             <Button
              type="button"
      ...
      {!readOnly && questions.length > 0 && (
       <div className="flex justify-end gap-3 pb-lg">
        <Button
         ...
         onClick={() => save(false)}
         disabled={saving || !canSave}
         className="bg-primary text-primary-foreground px-lg h-auto py-sm rounded-lg font-label-md disabled:opacity-50 nudge-hover"
        >
         {saving ? "Saving…" : "Save draft"}
        </Button>
        <Button
