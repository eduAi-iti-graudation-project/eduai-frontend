   ...
   <div className="px-6 pb-6 flex-1 min-h-0">
    <div className="mb-4 flex items-center gap-3">
     <Select value={offeringId} onValueChange={setOfferingId}>
      <SelectTrigger className="form-input-focus rounded-full bg-surface px-3 py-2 text-label-md text-on-surface w-auto min-w-[220px]">
    ...
    <DialogContent>
     ...
     <div className="space-y-4">
      <div>
       ...
       <Select value={offeringId} onValueChange={setOfferingId}>
        <SelectTrigger className="w-full form-input-focus rounded-full bg-surface px-3 py-2 text-label-md text-on-surface">
      ...
      <div>
       ...
       <input
        ...
        className="w-full form-input-focus rounded-full bg-surface px-3 py-2 text-label-md text-on-surface"
       />
