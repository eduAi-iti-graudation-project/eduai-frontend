    ...
    <div className="flex-1 p-xl max-w-7xl mx-auto w-full">
      ...
      {grade.sections.length === 0 && grade.courses.length === 0 ? (
        ...
        <div className="space-y-xl">
          {/* Sections */}
          <section>
            <h2 className="font-headline-lg text-headline-lg text-on-surface mb-md">Sections</h2>
          ...
          {/* Courses */}
          <section>
            <h2 className="font-headline-lg text-headline-lg text-on-surface mb-md">Courses</h2>
