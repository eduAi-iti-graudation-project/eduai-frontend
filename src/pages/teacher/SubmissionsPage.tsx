...
export function SubmissionsPage() {
  ...
  const { submissions, isLoading, isError, error, gradeSubmission, confirmGrade } = useSubmissions(
      ...
      <div className="flex min-h-screen bg-surface">
        ...
        <div className="flex-1 flex flex-col">
          <header className="hidden md:flex items-center justify-between px-md py-4 bg-surface-container-lowest border-b border-outline-variant/20 sticky top-0 z-30">
            <h1 className="font-headline-lg text-headline-lg text-primary">Submissions</h1>
          </header>
          <main className="flex-1 flex items-center justify-center p-md">
            <div className="text-center w-full">
              ...
              <button
                ...
                className="px-md py-sm bg-secondary-container text-white rounded-full font-label-md text-label-md shadow-lg nudge-hover"
              >
                Try Again
              </button>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-md mb-lg">
            ...
            {!isLoading && submittedSubs.length > 0 && (
              <button
                ...
                className="flex items-center gap-xs px-md py-sm bg-secondary-container text-white rounded-full font-label-md text-label-md shadow-lg nudge-hover active:scale-95 disabled:opacity-50"
              >
                {bulkState ? (
                  <>
          ...
          <div className="bg-surface-container-lowest/60 backdrop-blur-md rounded-3xl p-md mb-xl flex flex-wrap gap-md items-center justify-between border border-outline-variant/30">
            <div className="flex items-center gap-sm">
              ...
              <select
                ...
                className="bg-transparent border-b-2 border-outline-variant py-1 pr-base focus:border-primary outline-none text-label-md font-label-md text-on-surface"
              >
            ...
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant">
                  {statusFilter ? "No submissions match the selected filter." : "Submissions from students will appear here."}
                </p>
              </div>
            </div>
          ) : (
