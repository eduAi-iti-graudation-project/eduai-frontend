 ...
 return (
  <div className="p-xl max-w-2xl mx-auto w-full space-y-6">
   <header className="mb-lg">
    <h1 className="font-headline-xl text-headline-xl text-primary mb-1">Settings</h1>
 ...
 const field = (label: string, value: string, onChange: (v: string) => void, type = "text") => (
  <div>
   ...
   <Input
    ...
    className="mt-1.5 rounded-md bg-surface-container-lowest font-medium text-body-md"
   />
  </div>
 )
