   ...
   <div className="flex-1 p-md overflow-y-auto">
    <div className="max-w-3xl mx-auto space-y-4">
     ...
     {questions.map((question, index) => {
      ...
      return (
       <div key={question.id} className="rounded-lg bg-surface-container-lowest p-md ">
        <div className="flex items-start justify-between gap-3 mb-sm">
         <div className="flex items-center gap-2 min-w-0">
          ...
          {isConfirmed && (
           <Badge
            variant="outline"
            className="border-transparent font-label-sm text-label-sm px-2 py-0.5 bg-primary text-primary-foreground shrink-0"
           >
            Confirmed
           </Badge>
          )}
        ...
        <div className="mt-4 flex items-center gap-2 justify-end">
         <label className="font-label-sm text-label-sm text-on-surface-variant">
          ...
          <Input
           ...
           className="ml-2 w-20 h-auto rounded-lg bg-surface px-2 py-1.5 text-sm text-on-surface form-input-focus"
          />
         </label>
         <Button
          type="button"
