...
function MeetingCard({ meeting, basePath }: { meeting: MeetingSummary; basePath: string }) {
  return (
    <Link
      ...
      className="block rounded-2xl border border-border bg-surface-container-lowest p-md hover:shadow-md hover:border-primary/40 transition-shadow"
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <h3 className="font-label-lg text-label-lg text-on-surface font-semibold truncate">{meeting.title}</h3>
