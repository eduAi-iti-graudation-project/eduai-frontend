    ...
    <div className="h-full flex flex-col bg-[#0d1226] text-white">
      <header className="px-lg py-sm flex items-center justify-between border-b border-white/10">
        ...
        <Link
          ...
          className="font-label-sm text-label-sm text-white/50 hover:text-white transition-colors"
        >
          View details
        </Link>
      </header>
          ...
          <div className="flex-1 p-md overflow-y-auto">
            {call.error ? (
              <div className="h-full flex flex-col items-center justify-center gap-3 text-center">
                ...
                <p className="font-body-md text-body-md text-white/80 max-w-md">{call.error}</p>
                <p className="font-label-sm text-label-sm text-white/50">You may need to refresh and try again.</p>
              </div>
            ) : (
              <div
                className={cn(
