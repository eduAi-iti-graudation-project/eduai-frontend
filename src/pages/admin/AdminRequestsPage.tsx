...
export function AdminRequestsPage() {
 ...
 return (
  <div className="flex-1 p-xl max-w-6xl mx-auto w-full space-y-md">
   ...
   {/* Join code card */}
   <div className="rounded-lg bg-surface-container-lowest border border-border p-md flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    <div className="flex items-center gap-3">
     ...
     <div>
      ...
      <h2 className="font-headline-md text-headline-md text-primary">School join code</h2>
    ...
    <div className="flex flex-wrap items-center gap-3">
     {org?.joinCode ? (
      <>
       <div className="flex items-center gap-2 rounded-lg bg-surface-container-low px-md py-2.5">
        <span className="font-headline-md text-headline-md text-on-surface tracking-[0.2em]">{org.joinCode}</span>
       </div>
       <Button
        variant="outline"
className="rounded-full font-label-md text-label-md border border-border bg-background text-primary hover:bg-surface-container h-auto px-md py-2.5"
       ...
       <Button
        variant="outline"
        className="rounded-full font-label-md text-label-md border border-border bg-background text-on-surface-variant hover:bg-surface-container h-auto px-md py-2.5"
    ...
    <div className="rounded-lg border border-error/30 bg-error-container/60 p-md flex items-center justify-between gap-4">
     <div className="flex items-center gap-3">
      ...
      <p className="font-body-md text-body-md text-on-error-container">
       ...
       <a href="/admin/billing" className="font-semibold underline underline-offset-2">
        Upgrade your plan
       </a>{" "}
       to add more members.
      </p>
     ...
     <TabsList className="bg-surface-container-low rounded-lg p-1 h-auto">
      {TABS.map((tab) => (
       <TabsTrigger
        key={tab.value}
        value={tab.value}
        className="rounded-full px-md py-2 font-label-md text-label-md data-[state=active]:bg-primary-container data-[state=active]:text-on-primary-container data-[state=active]:shadow-card"
       >
        {tab.label}
       </TabsTrigger>
      ))}
