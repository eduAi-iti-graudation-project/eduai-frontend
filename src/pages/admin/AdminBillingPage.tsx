  ...
  <div className="flex-1 p-xl max-w-6xl mx-auto w-full space-y-md">
   ...
   {isGrouped && (
    <div className="rounded-lg bg-primary-container border border-primary/30 p-md flex flex-col md:flex-row md:items-center md:justify-between gap-4">
     ...
     <Button
      variant="outline"
      className="rounded-lg font-label-md text-label-md border border-primary bg-background text-primary hover:bg-primary-container h-auto px-5 py-2.5"
      onClick={() => {
    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
     <div className="flex items-center gap-3">
      ...
      <div>
       ...
       <h2 className="font-headline-md text-headline-md text-primary">Current plan: {tierLabel(org.subscriptionTier)}</h2>
     ...
     return (
      <div
       ...
       className={`flex flex-col rounded-lg p-6 border ${
        isCurrent
         ? "bg-primary-container text-on-primary-container border-primary/30 shadow-card"
      ...
      >
       <div className="flex items-center justify-between">
        ...
        {isCurrent && (
         <span className="inline-flex items-center gap-1 rounded-lg bg-background/90 px-3 py-1 font-label-sm text-label-sm text-primary">
