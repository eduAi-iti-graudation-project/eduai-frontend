   ...
   <div className="max-w-[1600px] mx-auto space-y-4">
    ...
    {showCreateGrade && (
     <div className="rounded-lg bg-surface-container-lowest p-md">
      <h2 className="font-headline-md text-headline-md text-primary mb-4">Create grade level</h2>
      <div className="flex items-end gap-3">
       <div className="flex-1">
        ...
        <Input
         ...
         className="w-full px-3 py-2 rounded-md font-body-md text-body-md bg-surface-container-low outline-none focus:border-primary h-auto focus-visible:ring-transparent focus-visible:ring-offset-0"
        />
       </div>
       <div className="flex-[2]">
        ...
        <Input
         ...
         className="w-full h-10 px-3 py-2 rounded-md font-body-md text-body-md bg-surface-container-low outline-none focus:border-primary focus-visible:ring-transparent focus-visible:ring-offset-0"
        />
       </div>
       <Button
        type="button"
    ...
    {list.length === 0 ? (
     <div className="rounded-lg bg-surface-container-lowest p-10 text-center">
      <span className="material-symbols-outlined text-[40px] text-outline inline-block mb-2">school</span>
      <h3 className="font-headline-md text-headline-md text-primary">No grade levels yet</h3>
       ...
       <div className="rounded-lg bg-surface-container-lowest p-md">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
         ...
         <div className="flex items-center gap-2">
          <button
           ...
           className="w-9 h-9 flex items-center justify-center rounded-md text-error hover:bg-error-container transition-colors shrink-0"
           title="Delete grade"
          >
          ...
          <div className="grid gap-3 md:grid-cols-[1fr_1fr_auto]">
           <div>
            ...
            <Input
             ...
             placeholder="e.g. 9A"
             className="w-full px-3 py-2 rounded-lg font-body-md bg-surface-container-lowest outline-none focus:border-primary h-auto focus-visible:ring-transparent focus-visible:ring-offset-0"
            />
           </div>
           <div>
        ...
        <div className="rounded-lg overflow-hidden mb-4">
         <div className="flex items-center justify-between gap-3 px-4 py-3 bg-surface-container-low border-b border-outline-variant">
          <h3 className="font-label-lg text-label-lg text-primary uppercase tracking-[0.02em] flex items-center gap-2">
           ...
           <table className="w-full min-w-[560px]">
            <thead>
             <tr className="border-b border-outline-variant">
              <th className="text-left font-label-sm text-label-sm text-on-surface-variant uppercase tracking-[0.02em] px-4 py-2.5 min-w-40">
               Section
              </th>
              {gradeCourses.map((c) => (
               <th key={c.id} className="text-left font-label-sm text-label-sm text-on-surface-variant uppercase tracking-[0.02em] px-4 py-2.5">
                {c.name}
               </th>
              ))}
             </tr>
                 ...
                 <td key={c.id} className="px-4 py-2.5">
                  <div className="flex items-center gap-1.5">
                   <select
                    ...
                    className="px-2 py-1.5 rounded-md font-body-sm text-body-sm bg-surface-container-lowest outline-none focus:border-primary w-full min-w-32"
                   >
        ...
        <div className="grid gap-4 xl:grid-cols-2">
         <div>
          <h3 className="font-label-lg text-label-lg text-primary uppercase tracking-[0.02em] mb-3 flex items-center gap-2">
          ...
          {gradeSections.length === 0 ? (
           ...
           <div className="space-y-2">
            {gradeSections.map((s) => (
             <div key={s.id} className="rounded-lg bg-surface-container-low px-4 py-3">
         ...
         <div>
          ...
          {gradeCourses.length === 0 ? (
           ...
           <div className="space-y-2">
            {gradeCourses.map((c) => (
             <div key={c.id} className="rounded-lg bg-surface-container-low px-4 py-3">
              <div className="flex items-center gap-3">
