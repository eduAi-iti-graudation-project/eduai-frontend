 ...
 if (attemptStatus === "IN_PROGRESS") {
  return (
   <div className="flex-1 p-xl max-w-2xl mx-auto w-full flex flex-col items-center justify-center text-center">
    ...
    <h1 className="font-headline-lg text-headline-lg text-primary mb-2">Quiz still in progress</h1>
  ...
  <div className="flex-1 p-xl max-w-2xl mx-auto w-full">
   ...
   {!detail ? (
    ...
    <div className="space-y-4">
     <div className="rounded-lg bg-surface-container-lowest p-xl text-center ">
