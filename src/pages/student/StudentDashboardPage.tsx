...
function Metric({ label, icon, value, caption, to, tone }: { label: string; icon: string; value: string | number; caption: string; to?: string; tone?: string }) {
 ...
 const card = (
  <div className="bg-surface-container-lowest rounded-lg p-4 shadow-card flex flex-col gap-2 hover:border-primary-container/40 transition-colors h-full">
...
export function StudentDashboardPage() {
 ...
 return (
  <div className="flex-1 p-margin-desktop max-w-7xl mx-auto w-full">
   ...
   <div className="stagger-enter grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
    <div className="rounded-lg bg-surface-container-lowest p-md shadow-card">
     <div className="flex items-center justify-between mb-3">
      <h2 className="font-headline-md text-headline-md text-primary">Upcoming deadlines</h2>
    ...
    <div className="rounded-lg bg-surface-container-lowest p-md shadow-card">
     <div className="flex items-center justify-between mb-3">
      <h2 className="font-headline-md text-headline-md text-primary">Upcoming meetings</h2>
   ...
   <div className="rounded-lg bg-surface-container-lowest p-md shadow-card mb-6">
    <div className="flex items-center justify-between mb-4">
     <h2 className="font-headline-md text-headline-md text-primary">Recent grades</h2>
   ...
   <div className="rounded-lg bg-surface-container-lowest p-md shadow-card">
    ...
    <div className="stagger-enter grid grid-cols-2 md:grid-cols-4 gap-3">
     {QUICK_LINKS.map((q) => (
      <Link
       key={q.to}
       to={q.to}
       className="flex items-start gap-3 rounded-lg border border-border bg-background p-3 hover:border-primary-container/40 hover:shadow-card-hover transition-all"
      >
