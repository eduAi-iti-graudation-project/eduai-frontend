...
function StatCard({
 ...
 return (
  <div
   className="bg-background rounded-xl border border-border p-md flex items-center gap-md animate-[rise-in_500ms_ease-out_both]"
...
function Card({ title, subtitle, children }: { title: string; subtitle?: string; children: ReactNode }) {
 return (
  <div className="bg-background rounded-lg border border-border p-xl">
   <div className="mb-lg">
