  ...
  <div className="flex-1 p-margin-desktop max-w-5xl mx-auto w-full">
   <div className="flex items-center gap-3 mb-4">
    ...
    <Link
     ...
     className="ml-auto inline-flex items-center gap-1.5 bg-primary text-primary-foreground px-md py-2 rounded-full font-label-md text-label-md hover:opacity-90 transition-opacity shrink-0"
    >
   ...
   {assignment.description && (
    <div className="rounded-lg bg-background p-md border border-border mb-6">
     ...
     <div className="shrink-0">
      {submission ? (
       ...
       <Button
        ...
        className="bg-primary text-primary-foreground px-md py-sm rounded-full font-label-md hover:bg-primary/90 active:scale-95 transition-all h-auto"
       >
   ...
   {mergedGrades.length === 0 ? (
    <div className="rounded-lg bg-background p-md border border-border text-center py-xl">
    ...
    <div className="space-y-4">
     <div className="rounded-lg bg-background p-md border border-border">
   ...
   {submitOpen && (
    <Dialog open onOpenChange={(next) => { if (!next) setSubmitOpen(false) }}>
     <DialogContent className="rounded-lg w-full max-w-[768px] bg-popover p-xl shadow-xl max-h-[85vh] overflow-y-auto">
      <div className="flex items-center justify-between mb-4">
       <DialogTitle className="font-headline-md text-headline-md text-on-surface">Submit Assignment</DialogTitle>
      </div>
      ...
      <div className="flex justify-end gap-3 mt-6">
       <Button
        ...
        className=" text-on-surface-variant px-md py-sm rounded-lg font-label-md hover:bg-surface-container h-auto"
       >
        Cancel
       </Button>
       <Button
