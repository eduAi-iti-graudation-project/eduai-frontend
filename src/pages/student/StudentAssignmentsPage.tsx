...
<div className="space-y-3">
          ...
          return (
           <div
            key={a.id}
            className="rounded-lg bg-background p-md border border-border hover:border-primary-container/30 hover:shadow-card-hover transition-all"
           >
            <div className="flex items-start justify-between gap-4">
             <div className="flex-1">
              <h3 className="font-label-md text-label-md text-primary">{a.title}</h3>
              {a.description && (
               ...
               <div className="flex flex-wrap items-center gap-2 mt-2">
                {a.materials.map((m) => (
                 <button
                  ...
                  className="inline-flex items-center gap-1.5 px-sm py-1 rounded-md bg-surface-container-low hover:border-primary hover:text-primary transition-colors font-label-sm text-label-sm text-on-surface-variant"
