  ...
  <div className="flex-1 p-xl max-w-3xl mx-auto w-full">
   ...
   <div className="mb-lg">
    <Select value={courseFilter} onValueChange={setCourseFilter}>
     <SelectTrigger className="form-input-focus rounded-lg bg-surface px-3 py-2 text-sm text-on-surface w-auto min-w-[180px]">
   ...
   {history.isLoading ? (
    ...
    <EmptyState
     ...
     action={
      <Link
       to="/student/homework-help"
       className="inline-block bg-primary text-primary-foreground px-md py-sm rounded-lg font-label-md hover:opacity-90 transition-all"
      >
