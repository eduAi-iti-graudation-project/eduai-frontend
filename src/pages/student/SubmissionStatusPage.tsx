  ...
  return (
   <div className="flex items-center justify-center h-full p-margin-desktop">
    <div className="text-center">
     ...
     <h2 className="font-headline-md text-headline-md text-primary mb-sm">Failed to load submission</h2>
     <p className="font-body-md text-body-md text-on-surface-variant mb-4">
      {error instanceof Error ? error.message : "Submission not found"}
     </p>
     <Link to={backTo} className="bg-primary text-primary-foreground px-md py-sm rounded-full font-label-md">
      Back to course
     </Link>
    </div>
   </div>
  ...
  <div className="flex-1 p-margin-desktop max-w-5xl mx-auto w-full">
   <div className="flex items-center justify-between mb-4">
    <div className="flex items-center gap-3">
     <Link to={backTo} className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-surface-container transition-colors">
    ...
    {status === "SUBMITTED" || status === "GRADING_IN_PROGRESS" ? (
     <div className="rounded-lg bg-background p-md border border-border text-center">
