    ...
    <div className="flex flex-col h-full">
      <header className="flex items-center gap-3 px-md py-4 bg-surface-container-lowest border-b border-outline-variant">
        ...
        <div className="min-w-0">
          <h1 className="font-label-md text-label-md text-on-surface truncate">{peerName}</h1>
      ...
      <footer className="border-t border-outline-variant bg-surface-container-lowest p-md mb-24 md:mb-0">
        <div className="flex items-end gap-2 max-w-3xl mx-auto w-full">
          <textarea
            ...
            className="flex-1 resize-none rounded-[20px] bg-surface-container-high px-md py-sm font-body-md text-body-md text-on-surface placeholder:text-on-surface-variant outline-none focus:ring-2 focus:ring-primary/50 min-h-[44px] max-h-[160px]"
          />
          <Button
            onClick={handleSend}
            disabled={!canSend}
