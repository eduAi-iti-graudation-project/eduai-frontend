...
export function ReportsPage() {
 ...
 return (
  <div className="flex-1 p-xl max-w-4xl mx-auto w-full">
   ...
   <div className="bg-surface-container-lowest rounded-lg p-md mb-xl">
    ...
    <div className="flex gap-sm">
     <Input
      ...
      className="flex-1 h-auto rounded-lg bg-surface px-4 py-2 font-body-md text-body-md text-on-surface form-input-focus"
     />
     <Button
      type="button"
   ...
   {isLoading ? (
    ...
    <div className="space-y-sm">
     {reports.map((r) => (
      <div key={r.id} className="bg-surface-container-lowest rounded-lg overflow-hidden">
       <Button
        type="button"
        variant="ghost"
       ...
       >
        <div>
         <h3 className="font-label-md text-label-md text-primary">Report</h3>
