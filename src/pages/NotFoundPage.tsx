...
export function NotFoundPage() {
 ...
 return (
  <div className="min-h-screen bg-surface flex flex-col">
   ...
   <main className="flex-grow flex items-center justify-center px-margin-mobile md:px-margin-desktop py-lg">
    <div className="max-w-2xl w-full flex flex-col items-center">
     <div ref={cardRef} className="p-8 md:p-12 w-full flex flex-col items-center text-center shadow-card transition-transform duration-200 ease-out rounded-lg bg-surface-container-lowest ">
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full justify-center">
       <Button
        asChild
        className="bg-primary text-primary-foreground px-8 py-3 h-auto rounded-full font-label-md text-label-md flex items-center justify-center gap-2 transition-all hover:brightness-110 hover:bg-primary/90 active:scale-95 shadow-card nudge-hover no-underline"
       >
      ...
      <div className="mt-12 p-4 border-[1.5px] border-dashed border-primary bg-primary/5 rounded-lg flex items-start gap-3 text-left max-w-2xl">
       ...
       <div>
        ...
        <p className="font-body-md text-body-md text-on-surface-variant text-label-md">Our AI can help you find your teaching materials. Try searching in the main dashboard.</p>
       </div>
      </div>
     </div>
