      ...
      {open && (
        <div className="px-md pb-md space-y-4">
          ...
          {content.patternAnalysis && (
            <div>
              <h4 className="font-label-md text-label-md text-on-surface mb-2">Pattern Analysis</h4>
          ...
          {content.strategies.length > 0 && (
            <div>
              <h4 className="font-label-md text-label-md text-on-surface mb-2">Strategies</h4>
