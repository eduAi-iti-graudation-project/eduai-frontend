export function SocialLogin() {
  return (
    <div className="grid grid-cols-2 gap-4">
      <button
        type="button"
        className="flex items-center justify-center gap-3 py-3 border border-border rounded-lg hover:bg-surface transition-colors font-label-md text-on-surface"
      >
