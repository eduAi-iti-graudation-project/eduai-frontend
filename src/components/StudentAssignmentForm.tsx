...
export function StudentAssignmentForm() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <aside className="hidden md:flex flex-col h-screen w-64 bg-surface-container-low py-6 px-3 gap-2 sticky top-0 shrink-0">
        <div className="flex flex-col gap-1 px-2 mb-12">
        ...
        <nav className="flex-grow space-y-1">
          ...
          <a className="flex items-center gap-3 px-4 py-3 bg-primary-container text-on-primary-container rounded-full font-bold scale-98 transition-all duration-200" href="#">
        ...
        <div className="mt-auto space-y-1 pt-2 border-t border-outline-variant/30">
          <a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-full transition-all duration-200" href="#">
      ...
      {/* Main Content */}
      <main className="flex-grow relative flex items-center justify-center p-6 lg:p-10 overflow-hidden">
        ...
        {/* Assignment Card */}
        <section className="relative z-10 w-full max-w-2xl bg-surface-container-lowest rounded-3xl shadow-xl shadow-on-background/5 border border-on-surface/5 p-8 lg:p-8">
          {/* Header */}
          <div className="mb-8">
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {selectedFile ? (
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <div className="flex items-center gap-2 bg-surface-variant/50 border border-outline-variant rounded-full py-1.5 pl-3 pr-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="pt-4 flex justify-end">
              <button
                ...
                className="submit-button-gradient text-white flex items-center gap-3 px-8 py-4 rounded-full font-bold transition-all group disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
      ...
      {/* Mobile Navigation */}
      <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 flex justify-around items-center bg-surface border-t border-outline-variant/30 py-2 px-4 pb-safe shadow-lg">
