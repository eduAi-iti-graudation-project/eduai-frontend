...
export function StudentAssignmentForm() {
 ...
 return (
  <div className="flex flex-col min-h-screen">
   {/* TopNavBar */}
   <header className="bg-surface flex justify-between items-center w-full px-margin-mobile py-base max-w-full fixed top-0 z-50">
    <div className="flex items-center gap-2">
     <span className="material-symbols-outlined text-primary font-bold text-headline-lg">school</span>
     <h1 className="font-headline-lg text-headline-lg font-bold text-primary">EduAI</h1>
    </div>
   ...
   <main className="flex-grow pt-20 pb-24 px-margin-mobile">
    <div className="relative bg-surface-container-lowest rounded-xl p-6 border border-border overflow-hidden">
     ...
     <form onSubmit={handleFormSubmit} className="relative z-10 space-y-6">
      ...
      <div>
       ...
       />
       {errors.notes && (
        <p className="text-error text-label-md mt-1">{errors.notes.message}</p>
       )}
      </div>
    ...
    <div className="mt-4 grid grid-cols-2 gap-4">
     <div className="bg-background/60 backdrop-blur-sm p-4 rounded-lg border border-on-surface/5 flex items-center gap-3">
   ...
   {/* BottomNavBar */}
   <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-margin-mobile py-base pb-safe bg-surface shadow-lg rounded-t-xl md:hidden">
