...
export function StudentSearchInput({
 ...
 return (
  <div ref={wrapperRef} className={cn("relative", className)}>
   <div className="flex items-center gap-2 px-4 py-3 bg-background border border-border rounded-full focus-within:border-primary focus-within:shadow-[0_0_0_3px_rgba(244,114,182,0.3)] transition-all">
    ...
    <input
     ...
     className="flex-1 bg-transparent border-none outline-none text-body-md text-body-md text-on-surface placeholder:text-muted-foreground"
    />
    {isSearching && (
