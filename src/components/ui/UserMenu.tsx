  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="h-10 w-10 rounded-lg p-0 bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 hover:opacity-90 transition-opacity"
      ...
      <DropdownMenuContent
        ...
        className="w-64 rounded-lg border-border p-1 bg-white"
      >
