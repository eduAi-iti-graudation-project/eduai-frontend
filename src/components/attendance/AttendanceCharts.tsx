...
<div className="flex flex-col items-center gap-lg">
    ...
    >
     <div className="absolute inset-[12%] flex flex-col items-center justify-center rounded-lg bg-background">
      <p className="font-headline-md text-headline-md text-on-surface leading-none">{stats.presentPercent}%</p>
