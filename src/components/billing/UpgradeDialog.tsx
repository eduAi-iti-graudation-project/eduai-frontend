...
export function UpgradeDialog({ open, onOpenChange, requiredTier }: UpgradeDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md rounded-lg bg-surface-container-lowest">
        <DialogHeader>
            ...
            {tiers.map((plan) => {
              ...
              return (
                <button
                  ...
                  className="w-full flex items-center gap-4 rounded-lg border border-border bg-white p-4 text-left transition-all hover:border-primary hover:scale-[1.01] active:scale-95 disabled:opacity-50 disabled:hover:border-surface-container-highest disabled:hover:scale-100"
                >
