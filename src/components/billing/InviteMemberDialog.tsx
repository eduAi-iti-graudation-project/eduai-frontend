 ...
 return (
  <Dialog open={open} onOpenChange={setOpen}>
   <DialogTrigger asChild>
    <Button className="rounded-full bg-primary text-primary-foreground font-label-md text-label-md px-md py-2.5 h-auto hover:scale-[1.01] hover:bg-primary/90 active:scale-95 transition-all">
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
     <div className="space-y-xs">
      ...
      <Input
       ...
       className="rounded-lg border border-border bg-background py-4 h-auto font-body-md text-body-md"
      />
     </div>
     <div className="space-y-xs">
     ...
     <DialogFooter>
      ...
      <Button
       ...
       className="rounded-full bg-primary text-primary-foreground font-label-md text-label-md px-md h-auto hover:scale-[1.01] hover:bg-primary/90 active:scale-95 disabled:opacity-50"
      >
