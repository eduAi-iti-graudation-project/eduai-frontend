  ...
  return (
    <div className={cn("flex flex-col h-full bg-surface-container-lowest", className)}>
      <div className="px-md py-sm border-b border-border flex items-center gap-2">
        ...
        <h2 className="font-label-lg text-label-lg text-on-surface">In-meeting chat</h2>
      </div>
              ...
              <div key={message.id} className={cn("flex", mine ? "justify-end" : "justify-start")}>
                <div
                  className={cn(
                    ...
                    mine ? "bg-primary text-white rounded-br-sm" : "bg-surface-container-high text-on-surface rounded-bl-sm",
                  )}
                >
                  {!mine && (
