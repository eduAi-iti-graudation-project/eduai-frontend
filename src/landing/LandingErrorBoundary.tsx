 ...
 render() {
  ...
  return (
   <div className="flex min-h-screen items-center justify-center bg-surface px-6">
    <div className="max-w-lg rounded-xl border border-border bg-surface-container-lowest p-8 shadow-card">
     <h1 className="font-headline-lg text-headline-lg text-primary">The 3D story couldn't load</h1>
